...
import {CheckCircle,TrendingDown,AccountCircle} from '@mui/icons-material';
import { ThemeProvider } from '@mui/material/styles';
import { useRouter } from 'next/navigation';
import LogoutIcon from '@mui/icons-material/Logout';
import { maintheme } from '@/styles/theme/dashboard';
              ...
              <Box sx={{ pr: { md: 4 } }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                  <AvatarGroup max={5} sx={{ '& .MuiAvatar-root': { width: 40, height: 40 } }}>
                    <Avatar src="/assets/imgs/avatars/2.png" />
                    <Avatar src="/assets/imgs/avatars/3.png" />
                    <Avatar src="/assets/imgs/avatars/15.png" />
                    <Avatar src="/assets/imgs/avatars/14.png" />
                    <Avatar src="/assets/imgs/avatars/11.png" />
                  </AvatarGroup>
                  <Box>
